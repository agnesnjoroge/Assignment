...
namespace Core.Services
{
    public class CustomerService
    {
        ...
        {
            var url = "http://grc-dkt-002.greencom.co.ke:8048/BC240/ODataV4/Company('CRONUS%20International%20Ltd.')/CustomerList";
        ...
        {
            var url = $"http://grc-dkt-002.greencom.co.ke:8048/BC240/ODataV4/Company('CRONUS%20International%20Ltd.')/CustomerList('{id}')";
            var response = await _httpClient.GetAsync(url);
